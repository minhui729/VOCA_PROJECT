...
def downgrade() -> None:
    ...
    sa.Column('dept_code', sa.VARCHAR(length=10), autoincrement=False, nullable=False),
    sa.Column('dept_name', sa.VARCHAR(length=50), autoincrement=False, nullable=False),
    sa.PrimaryKeyConstraint('dept_code', name='department_pkey'),
    postgresql_ignore_search_path=False
    )
    op.create_table('student',
    sa.Column('student_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('name', sa.VARCHAR(length=50), autoincrement=False, nullable=False),
    sa.Column('major', sa.VARCHAR(length=10), autoincrement=False, nullable=True),
    sa.Column('score', sa.DOUBLE_PRECISION(precision=53), server_default=sa.text('0.0'), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['major'], ['department.dept_code'], name=op.f('student_major_fkey')),
